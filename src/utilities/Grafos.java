...
//
//    }
	private int getindex(String verticeInicial){
		for (int i = 0; i < vertices.length; i++) {
			if (vertices[i].equalsIgnoreCase(verticeInicial)){
				return i;
			}
		}
		System.out.println("não foi possível encontrar o vértice");
		return 0;
	}
	
//    public String buscaProfundidade(String verticeInicial){
//		int inicialIndex = 0;
//		String[] marcado = new String[vertices.length];
//		marcado[inicialIndex] = "v";
...
//    }
    ...
    */
	...
	public String toString(){
		return(">>> Classe utilities.Grafos (G) <<<" + "\n\n" +
